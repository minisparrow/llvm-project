// RUN: mlir-opt vecadd.mlir | mlir-opt -gpu-kernel-outlining | mlir-opt -pass-pipeline='builtin.module(gpu.module(strip-debuginfo,convert-gpu-to-nvvm,gpu-to-cubin{chip=sm_70}))' | mlir-opt --convert-scf-to-cf -gpu-to-llvm | mlir-cpu-runner    --shared-libs=build/lib/libmlir_cuda_runtime.so    --shared-libs=build/lib/libmlir_runner_utils.so    --entry-point-result=void
...
//%11 = call @mgpuMemGetDeviceMemRef1dFloat(%5) : (memref<?xf32>) -> (memref<?xf32>)
  %12 = memref.cast %6 : memref<*xf32> to memref<5xf32>
  %13 = memref.cast %7 : memref<*xf32> to memref<5xf32>
  %14 = memref.cast %8 : memref<*xf32> to memref<5xf32>
